...
class ImageTopic(object):
    ...
    def __init__(self, name, msgs, fps):
        ...
        bridge = CvBridge()
        #self.images = [bridge.imgmsg_to_cv2(msg, IMAGE_COLOR_FORMAT)for msg in msgs]
        
        self.images = [bridge.imgmsg_to_cv2(msg, '8UC3') for msg in msgs]
...
def main():
    ...
    for topic in image_topics:
        ...
        vid_writer = cv2.VideoWriter(args.bagfile[0:-4]+'_'+file_name, fourcc, topic.fps,
                                     topic.frame_size)
